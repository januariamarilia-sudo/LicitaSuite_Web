...
def main():
    ...
    backup = PIPELINE.with_suffix(".py.bak_4_0_homologada")
...
"""
    ...
    if text != original:
        ...
        print("Agora rode:")
        print("git add licitasuite docs aplicar_patch_build_homologada_4_0.py")
        print('git commit -m "LicitaSuite Web 4.0 LTS build homologada"')
        print("git push")
    else:
