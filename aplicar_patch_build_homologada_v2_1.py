...
def main():
    ...
    backup = PIPELINE.with_suffix(".py.bak_4_0_homologada_v2_1")
...
"""
    ...
    print("Agora rode:")
    print("git add licitasuite docs aplicar_patch_build_homologada_v2_1.py")
    print('git commit -m "Build homologada v2.1 - CPF RG e orgao no preambulo"')
    print("git push")
